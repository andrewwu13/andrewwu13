...
[![Email](https://img.shields.io/badge/Email-andrewwuca%40gmail.com-D14836?style=flat&logo=gmail)](mailto:andrewwuca@gmail.com)
...
**Highlights:**
- 🤖 Real-time job scraping pipeline using Playwright to automate dynamic ATS portals (Workday, Greenhouse-style flows)
- 🧠 Resume–job keyword matching engine to rank postings based on relevance score
- 🔔 Event-driven Discord notification system with role-based job alerts
- ☁️ Cloud-deployed scraping + parsing workers on GCP for scalable execution
